1. Install dependencies by typing in the command: npm install express
...
4. Review the code of the app accessible through: http://localhost:3000/public/MuscleApp.html#/
